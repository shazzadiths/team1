...
#Emma
  Scenario: Webshop API should respond with status code 200 on get request
    When User make GET-request to "https://iths-team1.herokuapp.com/products"
    Then HTTP response status code should be 200
#Somayeh
  Scenario:Test get URL endpoint for products
    When user makes a GET request to "https://iths-team1.herokuapp.com/products"
    Then HTTP response status code should be 200
    And user should see a list of all products with size=20


  Scenario: Test get URL endpoint for categories
    When user makes a GET request to "https://iths-team1.herokuapp.com/products/categories"
    Then HTTP response status code should be 200
  ...
  Scenario: Test get product by Id
    When user makes a GET request to "https://iths-team1.herokuapp.com/products/18"
    Then HTTP response status code should be 200
...
#Vijaya
  Scenario: Test get URL endpoint for all the electronics products by category
      When User make a GET-request to "https://iths-team1.herokuapp.com/products/categories/electronics"
  ...
  Scenario: Test get URL endpoint for all the men's clothing products by category
    When User make a GET-request to navigate Men's Clothing "https://iths-team1.herokuapp.com/products/categories/men's clothing"
  ...
  Scenario: Test get URL endpoint for all the women's clothing products by category
    When User make a GET-request to navigate women's Clothing "https://iths-team1.herokuapp.com/products/categories/women's clothing"
